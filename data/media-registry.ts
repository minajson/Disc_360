...
export const mediaRegistry: MediaEntry[] = [
  ...
  },
  {
    ...
    purpose: "Coach living portrait (photo also accepted)",
    dimensions: "800×1000 (display ≤ 320 px) or 1200×1500 photo",
    ratio: "4:5",
    formats: "WebM (VP9) + MP4 (H.264) + JPEG poster · or WebP/JPEG photo",
    sizeTarget: "≤ 1 MB per file · poster ≤ 100 KB",
    suggestedContent:
      "Head-and-shoulders coach portrait, face ~60% of frame, calm confident expression, warm natural light",
    replacementPath:
      "public/media/coach-01.webm + coach-01.mp4 + coach-01-poster.jpg → <LeadershipPortraitPlaceholder src mp4Src poster>",
    status: "ready",
    video: { duration: "5–15 s loop", autoplay: true, audio: false },
  },
  {
