...
export const metadata: Metadata = { title: "Team Focus summary" };

interface PageProps {
  params: Promise<{ teamId: string }>;
}

export default async function TeamFocusSummaryPage({ params }: PageProps) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-5 py-10 sm:px-8 sm:py-14">
      <FocusTeamSummaryView summary={summary} />
      <div className="flex flex-wrap gap-3 border-t border-hairline pt-6">
        ...
        <Link
          href={`/app/teams/${teamId}/present/focus`}
